...
<img src="https://media.giphy.com/media/https://media0.giphy.com/media/v1.Y2lkPTZjMDliOTUyYml6ZnZodDdmcHVoM2s3aXh1dWZsdXVtdDBjMGxvYmU0ZjllODlsbSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/In0Lpu4FVivjISX9HT/giphy.gif/giphy.gif" width="300"/>

---

## 💻 Sobre mim
- 🌱 Atualmente estudando Java, Spring Boot, HTML, CSS, Linguagem C e Lógica de Programação
- 🔭 Desenvolvendo projetos práticos para portfólio
- 🤝 Aberta a colaborar em projetos para iniciantes
- ❓ Buscando evolução em backend e banco de dados
- 💬 Gosto de compartilhar minha jornada de aprendizado
- 📫 Contato: b4rbaranascimentogomes@gmail.com
...
## 🎯 Objetivos
- 👩‍💻 Tornar-me Desenvolvedora Backend Java
- 🤖 Trabalhar com Inteligência Artificial
- 🌎 Construir carreira internacional na tecnologia

---

## ⚡ Curiosidade
Acredito que pequenos passos todos os dias constroem grandes sonhos ✨
